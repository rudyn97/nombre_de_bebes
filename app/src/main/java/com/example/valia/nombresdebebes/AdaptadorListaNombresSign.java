...
public class AdaptadorListaNombresSign extends RecyclerView.Adapter<AdaptadorListaNombresSign.NombresViewHolder> implements View.OnClickListener {

    ArrayList<PersonaSign> listaPersonas;
    private View.OnClickListener listener;

    public AdaptadorListaNombresSign(ArrayList<PersonaSign> listaPersonas) {
